'''
< training_ResNet18_class_modified >
- data와 test_data에서 가방, 샌들, 스니커즈, 앵클부츠 삭제
...
print('[ResNet18] class:15, batch size:100, lr:0.001, epoch:30')
...
torch.save(model.state_dict(), PATH + 'ResNet18_class_modified.pt')